...
<body>
<?php $title = "YCP - Office";  echo "<div id='scholarship-sec'></div>"; ?>

<?php require("header.php"); ?>

<div id="side-nav">
<a href="office.php"><button style="background:blue;" class="scholarship-btn active">Scholarship</button></a> 
<a href="#fees-sec"><button style="background:green;" class="fees-btn">Fees</button></a> 
<a href="#bus-sec"><button style="background:orange;" class="bus-btn">Bus</button></a>
</div>
...
var btns = header.getElementsById("scholarship-btn");
